...
import { AnyOf, ReferenceTo, Sequence } from "./Parser/BuilderRules.ts";
...
const declaration = new AnyOf(
  new ReferenceTo("exprStmt"),
  new ReferenceTo("printStmt"),
);
...
export function tokensToAST(
  ...
  if (writeASTtoFile) {
    ...
    Deno.writeTextFile("./debug/ast.jsonc", astStr);
  }
